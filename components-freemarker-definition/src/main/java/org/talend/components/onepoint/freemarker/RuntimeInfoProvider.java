...
public final class RuntimeInfoProvider {
    ...
    public static final String MAVEN_RUNTIME_ARTIFACT_ID = "components-freemarker-definition";

    public static final String MAVEN_RUNTIME_URI = "mvn:" + MAVEN_GROUP_ID + "/" + MAVEN_RUNTIME_ARTIFACT_ID;

    public static final String RUNTIME_CLASS_NAME = "org.talend.components.onepoint.freemarker.runtime.reader.FreemarkerTransformSource"; //$NON-NLS-1$
    ...
    /**
     * Returns instance of {@link RuntimeInfo} for Input component with runtime class name FreemarkerTransformSource
     * 
