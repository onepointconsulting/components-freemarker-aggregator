...
public class OsgiFreemarkerTransformTestIT extends FreemarkerTransformTestBase {
    ...
    public Option[] config() {
        ...
        return options(composite(ComponentsPaxExamOptions.getOptions()), //
                ...
                linkBundle("org.talend.components-components-freemarker-definition-bundle"));
    }
